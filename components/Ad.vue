<template>
    <div class="text-white">
        <div class="flex flex-col gap-4 bg-information rounded-lg p-4 h-full">
...
<script setup>
    ...
    const props = defineProps(['name', 'button', 'title', 'desc']);
    const response = await searchData(props.name)
